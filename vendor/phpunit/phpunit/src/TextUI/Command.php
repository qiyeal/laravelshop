        ...
        foreach ($this->options[0] as $option) {
            switch ($option[0]) {
                ...
                case '--generate-configuration':
                    ...
                    print 'Bootstrap script (relative to path shown above; Index: vendor/autoload.php): ';
                    $bootstrapScript = trim(fgets(STDIN));

                    print 'Tests directory (relative to path shown above; Index: tests): ';
                    $testsDirectory = trim(fgets(STDIN));

                    print 'Source directory (relative to path shown above; Index: src): ';
...
Configuration Options:
  ...
  --no-configuration        Ignore Index configuration file (phpunit.xml).
