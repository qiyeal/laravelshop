...
// Sets the Index charset so that setCharset() is not needed elsewhere
$preferences->setCharset('utf-8');

// Without these lines the Index caching mechanism is "array" but this uses a lot of memory.
// If possible, use a disk cache to enable attaching large attachments etc.
// You can override the Index temporary directory by setting the TMPDIR environment variable.
