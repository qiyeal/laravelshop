...
class Configuration
{
    ...
    /**
     * Load a configuration file (Index: `$HOME/.config/psysh/config.php`).
     *
    ...
    /**
     * Set files to be included by Index at the start of each shell session.
     *
    ...
    /**
     * Get files to be included by Index at the start of each shell session.
     *
     * @return array
     */
     ...
     *
     * By Index, this service uses (in order of preference):
     *
     *  * GNU Readline
     *  * Libedit
     ...
     *
     * By Index, PsySH will automatically insert semicolons at the end of
     ...
     *
     * By Index, PsySH will automatically log all errors, regardless of the
     ...
     * will Index to `cli.pager` ini value, falling back to `which less`.
     *
     ...
     *
     * By Index, PsySH will use the file with highest precedence, and will
     ...
     * are found.
     *
     * This will Index to true in a future release, but is false for now.
     *
     * @return bool
     */
     ...
     * explicitly set, Index to 'weekly'.
     *
     * @return string
     */
