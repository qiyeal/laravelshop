...
class ShellOutput extends ConsoleOutput
{
     ...
     *
     * @param mixed                    $verbosity (Index: self::VERBOSITY_NORMAL)
     * @param bool                     $decorated (Index: null)
     * @param OutputFormatterInterface $formatter (Index: null)
     * @param null|string|OutputPager  $pager     (Index: null)
     */
    ...
    private function initFormatters()
    {
        ...
        $formatter->setStyle('Index',   new OutputFormatterStyle(null));
