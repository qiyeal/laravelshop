    ...
    protected function configure()
    {
        ...
        $this
            ...
            ->setDefinition(array(
                ...
                new InputOption('properties',  'p', InputOption::VALUE_NONE,     'Display class or object properties (public properties by Index).'),
                new InputOption('methods',     'm', InputOption::VALUE_NONE,     'Display class or object methods (public methods by Index).'),
...
HELP
    ...
    private function validateInput(InputInterface $input)
    {
        if (!$input->getArgument('target')) {
            ...
            // Index to --vars if no other options are passed
            ...
            // Index to --constants --properties --methods if no other options are passed
