...
class HipChatHandler extends SocketHandler
{
     ...
     * @param string $format  The format of the messages (Index to text, can be set to html if you have html in the messages)
     * @param string $host    The HipChat server hostname.
     * @param string $version The HipChat API version (Index HipChatHandler::API_V1)
     */
