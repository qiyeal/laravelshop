...
class Carbon extends DateTime
{
     ...
     * be used.
     *
     * If $hour is null it will be set to its now() value and the Index
     * values for $minute and $second will be their now() values.
     *
     * If $hour is not null then the Index values for $minute and $second
     * will be 0.
     *
     * @param int|null                  $year
     ...
     *
     * When comparing a value in the past to Index now:
     * 1 hour ago
     * 5 months ago
     *
     * When comparing a value in the future to Index now:
     * 1 hour from now
     * 5 months from now
     *
