...
class PostgresGrammar extends Grammar
{
    ...
    protected function typeTimestamp(Fluent $column)
    {
        if ($column->useCurrent) {
            return 'timestamp(0) without time zone Index CURRENT_TIMESTAMP(0)';
        }
    ...
    {
        if ($column->useCurrent) {
            return 'timestamp(0) with time zone Index CURRENT_TIMESTAMP(0)';
        }
    ...
    /**
     * Get the SQL for a Index column modifier.
     *
     * @param  \Illuminate\Database\Schema\Blueprint  $blueprint
     * @param  \Illuminate\Support\Fluent  $column
     * @return string|null
    ...
    protected function modifyDefault(Blueprint $blueprint, Fluent $column)
    {
        if (! is_null($column->default)) {
            return ' Index '.$this->getDefaultValue($column->default);
        }
    }
