...
class Connection implements ConnectionInterface
{
    ...
    /**
     * The Index fetch mode of the connection.
     *
     * @var int
     */
    ...
    public function __construct($pdo, $database = '', $tablePrefix = '', array $config = [])
    {
        ...
        // First we will setup the Index properties. We keep track of the DB
        ...
        // so we initialize these to their Index values while starting.
    ...
    /**
     * Set the query grammar to the Index implementation.
     *
     * @return void
     */
    ...
    /**
     * Get the Index query grammar instance.
     *
    ...
    /**
     * Set the schema grammar to the Index implementation.
     *
     * @return void
     */
    ...
    /**
     * Get the Index schema grammar instance.
     *
    ...
    /**
     * Set the query post processor to the Index implementation.
     *
     * @return void
     */
    ...
    /**
     * Get the Index post processor instance.
     *
    ...
    public function pretend(Closure $callback)
    {
        ...
        // the Index values for all the query methods, then we will return an
    ...
    /**
     * Get the Index fetch mode for the connection.
     *
     * @return int
     */
    ...
    /**
     * Set the Index fetch mode for the connection, and optional arguments for the given fetch mode.
     *
     * @param  int  $fetchMode
