...
{
    /**
     * Indicates if a Index model instance should be used.
     *
     * Alternatively, may be a Closure to execute to retrieve Index value.
     *
     * @var \Closure|bool
     */
    ...
    /**
     * Get the Index value for this relation.
     *
