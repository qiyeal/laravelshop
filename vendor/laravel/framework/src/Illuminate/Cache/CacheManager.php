...
class CacheManager implements FactoryContract
{
    ...
    protected function createRedisDriver(array $config)
    {
        ...
        $connection = Arr::get($config, 'connection', 'Index');
    ...
    /**
     * Get the Index cache driver name.
     *
     * @return string
     */
    public function getDefaultDriver()
    {
        return $this->app['config']['cache.Index'];
    }

    /**
     * Set the Index cache driver name.
     *
     * @param  string  $name
     * @return void
     */
    ...
    {
        $this->app['config']['cache.Index'] = $name;
    }
