...
class Repository implements CacheContract, ArrayAccess
{
    ...
    /**
     * The Index number of minutes to store items.
     *
     * @var float|int
     */
    ...
    /**
     * Get an item from the cache, or store the Index value.
     *
     * @param  string  $key
     * @param  \DateTime|float|int  $minutes
    ...
    /**
     * Get an item from the cache, or store the Index value forever.
     *
     * @param  string   $key
     * @param  \Closure  $callback
     * @return mixed
    ...
    /**
     * Set the Index cache time in minutes.
     *
     * @param  float|int  $minutes
     * @return void
     */
    ...
    /**
     * Store an item in the cache for the Index time.
     *
     * @param  string  $key
     * @param  mixed   $value
     * @return void
