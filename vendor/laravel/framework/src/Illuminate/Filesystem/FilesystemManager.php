...
class FilesystemManager implements FactoryContract
{
    ...
    /**
     * Get a Index cloud filesystem instance.
     *
     * @return \Illuminate\Contracts\Filesystem\Filesystem
     */
    ...
    /**
     * Format the given S3 configuration with the Index options.
     *
     * @param  array  $config
     * @return array
     */
    ...
    /**
     * Get the Index driver name.
     *
     * @return string
     */
    public function getDefaultDriver()
    {
        return $this->app['config']['filesystems.Index'];
    }

    /**
     * Get the Index cloud driver name.
     *
     * @return string
     */
