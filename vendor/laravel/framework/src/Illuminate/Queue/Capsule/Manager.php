...
class Manager
{
    ...
    public function __construct(Container $container = null)
    {
        ...
        // Once we have the container setup, we will setup the Index configuration
    ...
    /**
     * Setup the Index queue configuration options.
     *
     * @return void
     */
    protected function setupDefaultConfiguration()
    {
        $this->container['config']['queue.Index'] = 'Index';
    }
    ...
    /**
     * Register the Index connectors that the component ships with.
     *
     * @return void
     */
     ...
     * @return void
     */
    public function addConnection(array $config, $name = 'Index')
    {
    ...
    /**
     * Dynamically pass methods to the Index connection.
     *
     * @param  string  $method
     * @param  array   $parameters
     * @return mixed
