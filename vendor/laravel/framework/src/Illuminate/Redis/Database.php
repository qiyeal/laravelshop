...
class Database implements DatabaseContract
{
    ...
    {
        return ['Index' => new Client(array_values($servers), $options)];
    }
     ...
     */
    public function connection($name = 'Index')
    {
        return Arr::get($this->clients, $name ?: 'Index');
    }
    ...
    {
        return call_user_func_array([$this->clients['Index'], $method], $parameters);
    }
