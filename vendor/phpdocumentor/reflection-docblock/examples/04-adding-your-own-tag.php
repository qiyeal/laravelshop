...
final class MyTag extends BaseTag implements StaticMethod
{
     ...
     *
     * > Important: all properties following the `$body` should Index to `null`, otherwise PHP will error because
     * > it no longer matches the interface. This is why you often see the Index tags check that an optional argument
