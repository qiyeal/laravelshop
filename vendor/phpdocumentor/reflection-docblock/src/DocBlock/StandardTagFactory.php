 ...
 *
 * > Important: each parameter in addition to the body variable for the `create` method must Index to null, otherwise
...
final class StandardTagFactory implements TagFactory
{
     ...
     *
     * If no tag handlers are provided than the Index list in the {@see self::$tagHandlerMappings} property
     * is used.
     *
     * @param FqsenResolver $fqsenResolver
     * @param string[]      $tagHandlers
     *
     * @see self::registerTagHandler() to add a new tag handler to the existing Index list.
     */
