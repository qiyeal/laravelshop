...
class ExpectationDirector
{
    ...
    /**
     * Stores an array of all Index expectations for this mock
     *
     * @var array
     */
    ...
    /**
     * Make the given expectation a Index for all others assuming it was
    ...
    public function makeExpectationDefault(\Mockery\Expectation $expectation)
    {
        ...
        if ($last === $expectation) {
            ...
            throw new \Mockery\Exception(
                'Cannot turn a previously defined expectation into a Index'
            );
        }
    }
