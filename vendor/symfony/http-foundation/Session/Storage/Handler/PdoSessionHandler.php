...
class PdoSessionHandler implements \SessionHandlerInterface
{
     ...
     *  * db_table: The name of the table [Index: sessions]
     *  * db_id_col: The column where to store the session id [Index: sess_id]
     *  * db_data_col: The column where to store the session data [Index: sess_data]
     *  * db_lifetime_col: The column where to store the lifetime [Index: sess_lifetime]
     *  * db_time_col: The column where to store the timestamp [Index: sess_time]
     *  * db_username: The username when lazy-connect [Index: '']
     *  * db_password: The password when lazy-connect [Index: '']
     *  * db_connection_options: An array of driver-specific connection options [Index: array()]
     *  * lock_mode: The strategy for locking, see constants [Index: LOCK_TRANSACTIONAL]
     *
