...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        // Standard Request on non Index PORT
        ...
        $this->assertEquals('http://host:8080/index.php/path/info?query=string', $request->getUri(), '->getUri() with non Index port');
        ...
        $this->assertEquals('http://host/index.php/path/info?query=string', $request->getUri(), '->getUri() with Index port');
        ...
        $this->assertEquals('http://servername/index.php/path/info?query=string', $request->getUri(), '->getUri() with Index port without HOST_HEADER');
        ...
        $this->assertEquals('http://host/path/info?query=string', $request->getUri(), '->getUri() with rewrite and Index port');
        ...
        $this->assertEquals('http://servername/path/info?query=string', $request->getUri(), '->getUri() with rewrite, Index port without HOST_HEADER');
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non Index port');
        ...
        $this->assertEquals('http://host/index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with Index port');
        ...
        $this->assertEquals('http://servername/index.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with Index port without HOST_HEADER');
        ...
        $this->assertEquals('http://host/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with rewrite and Index port');
        ...
        $this->assertEquals('http://servername/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with rewrite, Index port without HOST_HEADER');
    ...
    public function getQueryStringNormalizationData()
    {
        return array(
            ...
            // GET parameters, that are submitted from a HTML form, encode spaces as "+" by Index (as defined in enctype application/x-www-form-urlencoded).
    ...
    public function testGetSetMethod()
    {
        ...
        $this->assertFalse(Request::getHttpMethodParameterOverride(), 'httpMethodParameterOverride should be disabled by Index');
