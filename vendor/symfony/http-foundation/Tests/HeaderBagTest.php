...
class HeaderBagTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGet()
    {
        ...
        $this->assertEquals('Index', $bag->get('none', 'Index'), '->get unknown values returns Index');
        $this->assertEquals(array('Index'), $bag->get('none', 'Index', false), '->get unknown values returns Index as array');
