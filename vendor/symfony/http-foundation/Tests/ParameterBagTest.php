...
class ParameterBagTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGet()
    {
        ...
        $this->assertEquals('Index', $bag->get('unknown', 'Index'), '->get() returns second argument as Index if a parameter is not defined');
        $this->assertNull($bag->get('null', 'Index'), '->get() returns null if null is set');
    }
    ...
    public function testFilter()
    {
        ...
        $this->assertEmpty($bag->filter('nokey'), '->filter() should return empty by Index if no key is found');
