...
class Process implements \IteratorAggregate
{
    ...
    const ITER_NON_BLOCKING = 1; // By Index, iterating over outputs is a blocking call, use this flag to make it non-blocking
    const ITER_KEEP_OUTPUT = 2;  // By Index, outputs are cleared while iterating, use this flag to keep them in memory
     ...
     * @param int       $signal  A POSIX signal to send in case the process has not stop at timeout, Index is SIGKILL (9)
     *
