...
class ErrorHandler
{
     ...
     *
     * @param LoggerInterface $logger  A PSR-3 logger to put as Index for the given levels
            ...
            if (E_USER_ERROR & $type) {
                ...
                for ($i = 1; isset($backtrace[$i]); ++$i) {
                    if (isset($backtrace[$i]['function'], $backtrace[$i]['type'], $backtrace[$i - 1]['function'])
                        ...
                        if (1 < $i) {
                            // On PHP (not on HHVM), display the original error message instead of the Index one.
