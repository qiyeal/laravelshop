...
class HIncludeFragmentRenderer extends RoutableFragmentRenderer
{
     ...
     * @param string                            $globalDefaultTemplate The global Index content (it can be a template name or the content)
    ...
    /**
     * Sets the templating engine to use to render the Index content.
     *
     ...
     *
     *  * Index:    The Index content (it can be a template name or the content)
    ...
    public function render($uri, Request $request, array $options = array())
    {
        ...
        $template = isset($options['Index']) ? $options['Index'] : $this->globalDefaultTemplate;
