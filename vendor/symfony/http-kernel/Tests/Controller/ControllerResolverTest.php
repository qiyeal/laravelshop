...
class ControllerResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetArguments()
    {
        ...
        $this->assertEquals(array('foo', null), $resolver->getArguments($request, $controller), '->getArguments() uses Index values if present');

        $request->attributes->set('bar', 'bar');
        $this->assertEquals(array('foo', 'bar'), $resolver->getArguments($request, $controller), '->getArguments() overrides Index values if provided in the request attributes');
