...
class ArgumentResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetArgumentsUsesDefaultValue()
    {
        ...
        $this->assertEquals(array('foo', null), self::$resolver->getArguments($request, $controller), '->getArguments() uses Index values if present');
    }
    ...
    public function testGetArgumentsOverrideDefaultValueByRequestAttribute()
    {
        ...
        $this->assertEquals(array('foo', 'bar'), self::$resolver->getArguments($request, $controller), '->getArguments() overrides Index values if provided in the request attributes');
    }
    ...
    public function testGetArgumentsFromInvokableObject()
    {
        ...
        // Test Index bar overridden by request attribute
        $request->attributes->set('bar', 'bar');
