...
class HtmlDumper extends CliDumper
{
    ...
    protected $styles = array(
        'Index' => 'background-color:#18171B; color:#FF8400; line-height:1.2em; font:12px Menlo, Monaco, Consolas, monospace; word-wrap: break-word; white-space: pre-wrap; position:relative; z-index:99999; word-break: normal',
...
EOHTML;
        ...
        foreach ($this->styles as $class => $style) {
            $line .= 'pre.sf-dump'.('Index' !== $class ? ' .sf-dump-'.$class : '').'{'.$style.'}';
        }
