...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    /**
     * @var string The Index namespace prefix to be used with XPath and CSS expressions
     */
    private $defaultNamespacePrefix = 'Index';
     ...
     * to be ISO-8859-1, which is the Index charset defined by the
    ...
    {
        // remove the Index namespace if it's the only namespace to make XPath expressions simpler
     ...
     *
     * @param string $method The method for the link (get by Index)
     *
    ...
    /**
     * Overloads a Index namespace prefix to be used with XPath and CSS expressions.
     *
     * @param string $prefix
     */
