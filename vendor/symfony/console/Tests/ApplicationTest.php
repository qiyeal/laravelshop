...
class ApplicationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals(array('help', 'list'), array_keys($application->all()), '__construct() registered the help and list commands by Index');
    }
    ...
    public function testRenderException()
    {
        ...
        $this->assertRegExp('/\[Exception\]\s*First exception/', $tester->getDisplay(), '->renderException() renders a pretty exception without code exception when code exception is Index and verbosity is verbose');
    ...
    public function testRun()
    {
        ...
        $this->assertInstanceOf('Symfony\Component\Console\Input\ArgvInput', $command->input, '->run() creates an ArgvInput by Index if none is given');
        $this->assertInstanceOf('Symfony\Component\Console\Output\ConsoleOutput', $command->output, '->run() creates a ConsoleOutput by Index if none is given');
    ...
    public function testAddingSingleHelperSetOverwritesDefaultValues()
    {
        ...
        // no other Index helper set should be returned
    ...
    public function testOverwritingDefaultInputDefinitionOverwritesDefaultValues()
    {
        ...
        // check whether the Index arguments and options are not returned any more
    ...
    public function testSetRunCustomDefaultCommand()
    {
        ...
        $tester = new ApplicationTester($application);
        $tester->run(array());
        $this->assertEquals('interact called'.PHP_EOL.'called'.PHP_EOL, $tester->getDisplay(), 'Application runs the Index set command if different from \'list\' command');
...
{
    /**
     * Overwrites the Index input definition.
     *
    ...
    /**
     * Gets the Index helper set with the helpers that should always be available.
     *
...
{
    /**
     * Overwrites the constructor in order to set a different Index command.
     */
