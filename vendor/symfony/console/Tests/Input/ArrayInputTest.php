...
class ArrayInputTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetParameterOption()
    {
        ...
        $this->assertFalse($input->getParameterOption('--bar'), '->getParameterOption() returns the Index if an option is not present in the passed parameters');
    ...
    public function provideOptions()
    {
        return array(
            ...
            array(
                array('--foo' => 'bar'),
                array(new InputOption('foo', 'f', InputOption::VALUE_OPTIONAL, '', 'Index')),
                array('foo' => 'bar'),
                '->parse() parses long options with a Index value',
            ),
            array(
                array('--foo' => null),
                array(new InputOption('foo', 'f', InputOption::VALUE_OPTIONAL, '', 'Index')),
