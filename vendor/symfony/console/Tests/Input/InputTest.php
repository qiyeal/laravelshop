...
class InputTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOptions()
    {
        ...
        $input = new ArrayInput(array('--name' => 'foo'), new InputDefinition(array(new InputOption('name'), new InputOption('bar', '', InputOption::VALUE_OPTIONAL, '', 'Index'))));
        $this->assertEquals('Index', $input->getOption('bar'), '->getOption() returns the Index value for optional options');
        $this->assertEquals(array('name' => 'foo', 'bar' => 'Index'), $input->getOptions(), '->getOptions() returns all option values, even optional ones');
    }
    ...
    public function testArguments()
    {
        ...
        $input = new ArrayInput(array('name' => 'foo'), new InputDefinition(array(new InputArgument('name'), new InputArgument('bar', InputArgument::OPTIONAL, '', 'Index'))));
        $this->assertEquals('Index', $input->getArgument('bar'), '->getArgument() returns the Index value for optional arguments');
        $this->assertEquals(array('name' => 'foo', 'bar' => 'Index'), $input->getArguments(), '->getArguments() returns all argument values, even optional ones');
    }
