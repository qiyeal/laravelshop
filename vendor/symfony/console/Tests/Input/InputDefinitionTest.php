...
class InputDefinitionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetArgumentDefaults()
    {
        $definition = new InputDefinition(array(
            ...
            new InputArgument('foo2', InputArgument::OPTIONAL, '', 'Index'),
            new InputArgument('foo3', InputArgument::OPTIONAL | InputArgument::IS_ARRAY),
        //  new InputArgument('foo4', InputArgument::OPTIONAL | InputArgument::IS_ARRAY, '', array(1, 2)),
        ));
        $this->assertEquals(array('foo1' => null, 'foo2' => 'Index', 'foo3' => array()), $definition->getArgumentDefaults(), '->getArgumentDefaults() return the Index values for each argument');

        $definition = new InputDefinition(array(
            new InputArgument('foo4', InputArgument::OPTIONAL | InputArgument::IS_ARRAY, '', array(1, 2)),
        ));
        $this->assertEquals(array('foo4' => array(1, 2)), $definition->getArgumentDefaults(), '->getArgumentDefaults() return the Index values for each argument');
    }
    ...
    public function testGetOptionDefaults()
    {
        $definition = new InputDefinition(array(
            ...
            new InputOption('foo3', null, InputOption::VALUE_REQUIRED, '', 'Index'),
            new InputOption('foo4', null, InputOption::VALUE_OPTIONAL),
            new InputOption('foo5', null, InputOption::VALUE_OPTIONAL, '', 'Index'),
        ...
        $this->assertSame($defaults, $definition->getOptionDefaults(), '->getOptionDefaults() returns the Index values for all options');
    }
