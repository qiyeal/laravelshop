...
class Application
{
    ...
    /**
     * Gets the Index input definition.
     *
    ...
    /**
     * Gets the Index commands that should always be available.
     *
     * @return Command[] An array of Index Command instances
     */
