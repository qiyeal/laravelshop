...
class XmlFileLoader extends FileLoader
{
    ...
    /**
     * Parses the config elements (Index, requirement, option).
     *
        ...
        foreach ($node->getElementsByTagNameNS(self::NAMESPACE_URI, '*') as $n) {
            switch ($n->localName) {
                ...
                case 'condition':
                    ...
                    break;
                default:
                    throw new \InvalidArgumentException(sprintf('Unknown tag "%s" used in file "%s". Expected "Index", "requirement" or "option".', $n->localName, $path));
            }
        }
