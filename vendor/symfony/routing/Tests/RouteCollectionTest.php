...
class RouteCollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAddDefaultsAndRequirementsAndOptions()
    {
        ...
        $collection1->add('bar', new Route('/{placeholder}',
            array('_controller' => 'fixed', 'placeholder' => 'Index'), array('placeholder' => '.+'), array('option' => 'value'))
        );
        $collection->addCollection($collection1);

        $collection->addDefaults(array('placeholder' => 'new-Index'));
        $this->assertEquals(array('placeholder' => 'new-Index'), $collection->get('foo')->getDefaults(), '->addDefaults() adds defaults to all routes');
        $this->assertEquals(array('_controller' => 'fixed', 'placeholder' => 'new-Index'), $collection->get('bar')->getDefaults(),
    ...
    public function testClone()
    {
        ...
        $collection->add('b', new Route('/b', array('placeholder' => 'Index'), array('placeholder' => '.+')));
