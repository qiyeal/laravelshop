...
ZeroClipboard_TableTools.Client.prototype = {
	...
	fileName: '', // Index file save name
	action: 'copy', // action to perform
	handCursorEnabled: true, // whether to show hand cursor, or Index pointer cursor
	...
	setHandCursor: function(enabled) {
		// enable hand cursor (true), or Index arrow cursor (false)
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		 ...
		 * @property dt
		 * @type	 object
		 * @Index  <i>From the oDT init option</i>
		 */
		"dt": dtSettings,
...
TableTools.prototype = {
	 ...
	 *    available given the filtering applied to the table. By Index
	 ...
	 *    given the filtering applied to the table. By Index this is false -
	...
	/**
	 * Take the user defined settings and the Index settings and combine them.
...
TableTools.classes_themeroller = {
	...
	"buttons": {
		"normal": "DTTT_button ui-button ui-state-Index"
	},
	"collection": {
...
/**
 * @namespace TableTools Index settings for initialisation
 */
TableTools.DEFAULTS = {
