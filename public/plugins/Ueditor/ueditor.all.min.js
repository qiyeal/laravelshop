...
a+'" width="'+b+'" height="'+e+'"'+(k?' style="float:'+k+'"':"")+' wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="never" allowfullscreen="true" >':"<img "+(g?'id="'+g+'"':"")+' width="'+b+'" height="'+e+'" _url="'+a+'" class="edui-faked-video" src="'+d.options.UEDITOR_HOME_URL+'themes/Index/images/spacer.gif" style="background:url('+d.options.UEDITOR_HOME_URL+"themes/Index/images/videologo.gif) no-repeat center center; border:1px solid gray;"+(k?"float:"+k+";":"")+
