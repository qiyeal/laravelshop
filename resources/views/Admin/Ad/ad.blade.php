        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body ">   
                    <!--表单数据-->
                    <form method="post" id="handleposition" action="{{url('admin/Ad/adHandle')}}" enctype="multipart/form-data">
                        <!--通用信息-->
                        {{csrf_field()}}
                        ...
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-8">
                                        <input type="text" class="form-control" name="ad_name" placeholder="自定义广告名称" >
                                        ...
                                        <div class="control-group">
                                                <div class="controls">
                                                        <div class="input-prepend input-group">
                                                                ...
                                                                <input type="text" style="width: 300px" name="begin" id="start_time" class="form-control" value="2016-01-01">
                                                        </div>
                                                </div>
                                        </div>
                                        </fieldset>
                                            ...
                                            <div class="control-group">
                                                    <div class="controls">
                                                            <div class="input-prepend input-group">
                                                                    ...
                                                                    <input type="text" style="width: 300px" name="end" id="end_time" class="form-control" value="2019-01-01">
                                                            </div>
                                                    </div>
                                            </div>
                                            </fieldset>
                                ...
                                <tr>
                                    <td>广告链接：</td>
                                    <td>
                                        <input type="text" class="form-control" name="ad_link" placeholder="javascript:void();">
                                    </td>
                                </tr> 
                                <tr>
                                    <td>广告图片：</td>
                                    <td>
                      					<div class="col-sm-3">
                      						<input type="file" class="form-control btn btn-default" style="width:350px;margin-left:-15px;" name="ad_code" id="ad_code">
                      					</div>
                      					<div class="col-sm-3">
                                ...
                                <tr>
                                	<td>背景颜色：</td>
                                	<td> <input class="form-control" name="bgcolor" type="color" style="width:200px;"/> </td>
                                </tr>
                                <tr>
                                    <td>默认排序：</td>
                                    <td>
                                        <input type="text" class="input-sm" name="orderby" placeholder="50">
                                    </td>
                                </tr>                                
                                </tbody> 
                                <tfoot>
