    ...
    @include('admin.Public.breadcrumb')
       ...
       <div class="row">
			...
			<div class="box box-info">
                ...
                <form class="form-horizontal" action="{{url('admin/Article/articleList/'.$res->article_id)}}" id="add_post" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{method_field('put')}}
                  <div class="box-body">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        	<select class="small form-control" name="cat_id" id="cat_id">
                                ...
                                @foreach($arr as $k=>$v)
                                        <option value="{{$k}}" @if($res->cat_id == $k) selected @endif>{{$v}}</option>
                                @endforeach
                        	</select>
                      </div>
                    </div>
                    <div class="form-group">
                    	...
                    	<div class="col-sm-8">
                            <input type="file" class="form-control" style="width:350px;" name="thumb" id="thumb" value="{{$res->thumb}}">
                        </div>
                    </div>
                    @if(!empty($res->thumb))
                    <div class="form-group">
                        <label for="text" class="col-sm-2 control-label">banner缩略图</label>
                        <div class="col-sm-8">
                            <img alt="" src="{{$res->thumb}}" width="80px" height="50px">
                        </div>
                     </div>
                    @endif
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="keywords"  value="{{$res->keywords}}">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="text" class="col-sm-2 control-label">外部链接</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="link"  value="{{$res->link}}">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                            <div class="input-prepend input-group">
                                ...
                                <input type="text" class="form-control" id ="publish_time" name="publish_time" value="{{date('Y-m-d', $res->publish_time)}}" >
                            </div>                        
                      </div>
                    </div>                   
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <div class="col-sm-2">
                           <label>
                               <input type="radio" name="is_open" value="1" @if($res->is_open==1) checked="checked" @endif>显示
                           </label>
                        </div>
                         <div class="col-sm-3">
                           <label><input type="radio" name="is_open" value="0" @if($res->is_open==0) checked="checked" @endif>不显示</label>
                        </div>
                      </div>
                    </div>    
                    <div class="form-group">
	                    ...
	                    <div class="col-sm-8">
				        <textarea class="form-control" id="post_description" name="description" title="">{{$res->description}}</textarea>
	                    </div>
                      </div>                        
                    <div class="form-group">
				        ...
				        {{--</textarea>--}}
                            ...
                            {{--<script id="editor" name="content" type="text/plain" style="width:860px;height:400px;">{!! $res->content !!}}</script>--}}
                            {{--<script type="text/javascript">--}}
                            ...
                            <script type="text/javascript" charset="utf-8" src="{{URL::asset('admins/style/ueditor/ueditor.all.min.js')}}"> </script>
                            <script type="text/javascript" charset="utf-8" src="{{URL::asset('admins/style/ueditor/lang/zh-cn/zh-cn.js')}}"></script>
                            <script id="editor" name="content" type="text/plain" style="width:710px;height:400px;">{!! $res->content !!}</script>
                            <script type="text/javascript">
                            var ue = UE.getEditor('editor');
                            </script>
                            <style>
