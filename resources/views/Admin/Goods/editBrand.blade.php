        ...
        @endif
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!--表单数据-->
                    @foreach($brand as $v)
                    <form method="post" id="addEditBrandForm" action="{{ url('admin/Goods/brandList/'.$v->id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}   
                    {{ method_field('PUT') }}          
                        <!--通用信息-->
                        ...
                        <div class="tab-pane active" id="tab_tongyong">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>品牌名称:</td>
                                    <td>
                                        <input type="text" value="{{ $v->name }}" name="name" class="form-control" style="width:200px;"/>                         
                                    </td>
                                </tr>                                
                                <tr>
                                    <td>品牌网址:</td>
                                    <td>
                                        <input type="text" value="{{ $v->url }}" name="url" class="form-control" style="width:250px;"/>
                                ...
                                <tr>
                                    <td>品牌排序:</td>
                                    <td>
                                        <input type="text" value="{{ $v->sort }}" name="sort" class="form-control" style="width:200px;" placeholder="50"/>                                
                                    </td>
                                </tr>                                                                 
                                <tr>
                                    <td>品牌描述:</td>
                                    <td>
										<textarea rows="4" cols="60" name="desc">{{ $v->desc }}</textarea>
